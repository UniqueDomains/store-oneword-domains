# Available .STORE One-Word Domains (74,176)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-74%2C176%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **74,176 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 74,176 domains · **Median ask:** $192.50 · **High-demand under $2,500:** 335
...
| hat.store     | premium   | $312.50   | $1,250        | medium         | low    | 3      | name.com                                                  |
...
| riblike.store | available | $0.98     | $43.98        | low            | low    | 7      | namecheap                                                 |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 74,176 live domains                        |
...
> Unique Domains. *Available .STORE One-Word Domains*. Version 2026-09-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
