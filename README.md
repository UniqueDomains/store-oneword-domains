# Available .STORE One-Word Domains (79,420)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-79%2C420%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **79,420 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 79,420 domains · **Median ask:** $264.81 · **High-demand under $2,500:** 257
...
| -------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------------------------------------------------------- |
| half.store     | premium   | $1,107    | $1,107        | high           | low    | 4      | namesilo                                                  |
| cell.store     | premium   | $3,450    | $3,450        | high           | low    | 4      | namesilo                                                  |
| flour.store    | premium   | $1,107    | $1,107        | high           | high   | 5      | namesilo                                                  |
...
| hat.store      | premium   | $1,107    | $1,107        | medium         | low    | 3      | namesilo                                                  |
| aground.store  | available | $0.98     | $43.98        | low            | low    | 7      | namecheap                                                 |
| online.store   | resell    | —         | —             | medium         | medium | 7      | Namify Domains Inc                                        |
| ivy.store      | premium   | $781.25   | —             | high           | low    | 3      | name.com                                                  |
| protem.store   | available | $0.98     | $43.98        | low            | low    | 7      | namecheap                                                 |
| pleasant.store | resell    | —         | —             | high           | low    | 8      | Xin Net Technology Corporation                            |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 79,420 live domains                        |
| Static CSV / JSON       | live search and daily refresh              |
| Basic exported fields   | 257 high-demand names under $2,500         |
...
> Unique Domains. *Available .STORE One-Word Domains*. Version 2026-09-24. Public GitHub extract for the exact Unique Domains search represented by this repository.
